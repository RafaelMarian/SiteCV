...
import { GraduationCap, Calendar, MapPin, BookOpen, ChevronDown, Award, School, FileText } from 'lucide-react';

const Education = ({ lang }) => {
  // State pentru a sti care card este expandat (folosim ID-ul)
    ...
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div className="education-timeline">
        {education.map((edu, index) => {
          ...
          // Alegem iconita in functie de nivel
          let Icon = School;
